...
monkeyInfo (end).units = 0;              % Analyse all units? (sorted units=0; all units=1)
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 1 2017';
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 2 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 10 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI' ...
'no 3D glasses today'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 11 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 15 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 16 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 17 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 18 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 19 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\May 22 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\May 23 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\May 24 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\May 25 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\May 26 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, fixed DCI, fixed ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 13 2017';
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 14 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, two DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 15 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, two DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [1 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 16 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, two DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [1 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 19 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, two DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [1 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 20 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, two DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [1 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 26 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, two DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 27 2017';
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 28 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 29 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jun 30 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 3 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 5 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 6 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 7 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 10 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 11 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 12 2017';
monkeyInfo (end).comments = {'four densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 13 2017';
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 14 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI' ...
'floor lifetime disabled'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\7a\Jul 17 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI' ...
'floor lifetime disabled'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 18 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Jul 19 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Aug 14 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Aug 25 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 9 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 10 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 11 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 12 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 13 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 16 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 17 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 20 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 23 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 25 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 26 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 27 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Oct 30 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 01 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 02 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 03 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'}; 
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 06 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 07 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 08 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 09 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 10 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 13 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 14 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 15 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 16 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 17 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 20 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 21 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 22 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 27 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 28 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 29 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Nov 30 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 04 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).coord.depth = 2850;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 05 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 06 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 07 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 08 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 18 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 19 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 20 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 21 2017';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, gain manipulation'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [0 1];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Dec 22 2017';
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Feb 19 2018';
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Feb 20 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Feb 21 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Feb 22 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Feb 26 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Feb 27 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Feb 28 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 01 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 05 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 06 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 07 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 08 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 09 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 12 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 13 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 14 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 15 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 16 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 21 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 22 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 23 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 26 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 27 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 28 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 29 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Mar 30 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Apr 2 2018';
monkeyInfo (end).comments = {'fixed density, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Apr 03 2018';
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Apr 04 2018';
monkeyInfo (end).comments = {'replay, two densities, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Bruno\U-probe\7a\Apr 05 2018';
monkeyInfo (end).comments = {'replay, two densities, no landmarks, no ptb, random DCI, random ITI, multifireflies'};
monkeyInfo (end).electrode_type = {'linearprobe24'};
monkeyInfo (end).area = {'PPC'};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Feb 05 2018';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Feb 06 2018';
monkeyInfo (end).comments = {'two densities, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Mar 01 2018';
monkeyInfo (end).comments = {'two densities, stimulus replay, no landmarks, no perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Mar 02 2018';
monkeyInfo (end).comments = {'two densities, stimulus replay, no landmarks, no perturbations, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Mar 05 2018';
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Mar 06 2018';
monkeyInfo (end).comments = {'perturbations, fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Mar 07 2018';
monkeyInfo (end).comments = {'perturbations, fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Mar 08 2018';
monkeyInfo (end).comments = {'perturbations, fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Schro\Utah Array\Mar 09 2018';
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 20 2019';
monkeyInfo (end).comments = {'gain manipulation,fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
monkeyInfo (end).FFparams_xpos = 4;
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 21 2019';
monkeyInfo (end).comments = {'gain manipulation,fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 24 2019';
monkeyInfo (end).comments = {'gain manipulation,fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 27 2019';
monkeyInfo (end).comments = {'perturbations, fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 28 2019';
monkeyInfo (end).comments = {'perturbations, fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Aug 30 2019';
monkeyInfo (end).comments = {'perturbations, fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Sep 02 2019';
monkeyInfo (end).comments = {'gain manipulation,fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Sep 03 2019';
monkeyInfo (end).comments = {'gain manipulation,fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Sep 04 2019';
monkeyInfo (end).comments = {'gain manipulation,fixed density, no landmarks, no ptb, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Sep 05 2019';
monkeyInfo (end).comments = {'perturbations,fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Sep 06 2019';
monkeyInfo (end).comments = {'perturbations,fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
...
monkeyInfo (end).coord.depth = nan;
monkeyInfo (end).units = 0;
monkeyInfo (end).folder = 'Ody\Utah Array\Sep 07 2019';
monkeyInfo (end).comments = {'perturbations,fixed density, no landmarks, random DCI, random ITI'};
monkeyInfo (end).electrode_type = {'utah2x48'};
monkeyInfo (end).area = {{'PPC', 'PFC'}};
monkeyInfo (end).eyechannels = [2 2];
